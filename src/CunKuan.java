...
public class CunKuan extends JFrame{
    Statement stmt;
    String Card;
    String Name;
    ...
    CunKuan(Statement stmt, String Card, String Name, double Money){
        final double[] money = {Money};
        this.setTitle("银行管理-存款");
...
//                    new BankManger(stmt, Card);
                    ...
                    BankManger.Write_Log(sqlDate,Name,"用户" + Name + "存款" + str + "元");
                    dispose();
                }catch (Exception e1){
                    e1.printStackTrace();
                }
